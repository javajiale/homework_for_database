...
public class FrmLogin extends JDialog implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == this.btnLogin) {
			...
			su.setXh(this.edtUserId.getText());
			su.setPassword(new String(this.edtPwd.getPassword()));
			String result = null;
			try {
				result = sum.logIn(su);
			...
			JOptionPane.showInternalMessageDialog(this,result,result, JOptionPane.INFORMATION_MESSAGE); 
